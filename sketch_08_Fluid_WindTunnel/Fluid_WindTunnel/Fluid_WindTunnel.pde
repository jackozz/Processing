 ...
 */
 ...
 /*
 ADAPTACIÓN DE SIMULACIÓN DE FLUIDOS (AVION)
 Autor: Jaime Cruz
 Fecha: 20200309
 */
...
//    pg_obstacles.noSmooth();
  ...
  //  pg_obstacles_drawing.noSmooth();
    ...
    pg_obstacles_drawing.rotate(0.0f);
    pg_obstacles_drawing.fill(200,0,0);
    pg_obstacles_drawing.textFont(font);
    pg_obstacles_drawing.text("Jaime Cruz", 0, 200);
  ...
  public void drawObstacles(){
    ...
    pg_obstacles.pushMatrix();
    {
      ...
      pg_obstacles.image(img, (width / 2) - 200, (height / 2) - 100);
    }
